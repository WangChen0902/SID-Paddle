...
last_epoch = 4000
data_prefix = './'
output_prefix = './result_paddle_Sony/'

input_dir = os.path.join(data_prefix, 'datasets/Sony/short/')
gt_dir = os.path.join(data_prefix, 'datasets/Sony/long/')
...
net_model = Network()
net_model.eval()
model_name = checkpoint_load_dir + 'model_%04d.pdparams' % last_epoch
